  ...
  <body>
    <div class="wrapper">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-items">
          ...
          <li><a href="datarmahasiswa.php" style="font-size: 15px;"><i class="fas fa-user-check"></i>Daftar Mahasiswa</a></li>
    ...
    <table class="tabel5">
      ...
      <tr>
          <td>NIDN</td>
          <td>:</td>
          <td><input type="text" name="nidn" required="required"></td>
      </tr>
      <tr>
          <td>Nama</td>
          <td>:</td>
      ...
      <tr>
          <td>Email</td>
          <td>:</td>
          <td><input type="text" name="email_dosen" required="required"></td>
      </tr>
      <tr>
          <td>Password</td>
          <td>:</td>
...
<?php
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO dosen VALUES
                    ('".$_POST['email']."','".$_POST['nidn']."', '".$_POST['nama_dosen']."', '".$_POST['email_dosen']."','".$_POST['password']."', '".$_POST['foto']."')");
          if($insert){
