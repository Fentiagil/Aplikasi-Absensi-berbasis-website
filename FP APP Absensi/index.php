        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="h2_ps">LOGIN E-Absensi</h2>
                </div>
                <div class="col-lg-12 ">
                    <a href="mahasiswa\loginmhs.php" style="text-decoration: none;"><button class="btn1 first1">Mahasiswa</button></a>
                    <a href="dosen\logindsn.php"  style="text-decoration: none;"><button class="btn2 first2">Dosen</button></a>
