        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="h2_ps">LOGIN MAHASISWA</h2></div>
                <form method="POST">
                <div class="col-lg-12 text-center ">
                    <input type="text" name="npm" class="form_login" placeholder="NPM .." >
                </div><br>
                <div class="col-lg-12 text-center ">
                     <input type="password" class="form_login" name="password" placeholder="Password" id="myPassword" required="required"><br/></div><br>
                <div class="col-lg-12 text-center ">
                ...
                if(isset($_POST['proseslog'])){
                    $sql = mysqli_query($koneksi, "select * from mahasiswa where npm = '$_POST[npm]' and password = '$_POST[password]'");
                    ...
                    if ($cek > 0) {
                        ...
                        echo "<meta http-equiv=refresh content=2;URL='loginmhs.php'>";
                    }
                }
                ?>
            </div>
